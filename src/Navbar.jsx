      ...
      <nav className="bg-white fixed w-full top-0 z-50  border-gray-200 dark:bg-orange-600">
        <div className="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4 ">
           ...
           <>
              ...
              <NavLink
                ...
                >
                  ...
                  <span className="absolute -right-1/2 -top-1/2 px-1 bg-red-700 rounded-sm   font-bold text-white">{localStorage.getItem('items')}</span>
                </NavLink>
              
              </li>
              <li>
                <button onClick={logout} className="block py-2 px-3   rounded hover:text-orange-600 dark:hover:text-black md:p-0 dark:text-white text-sm">
                  Logout
                </button>
              </li>
              </>
           }
         {
          ...
          <>
          <li>
               <NavLink to="/register" className="block py-2 px-3   rounded hover:text-orange-600 dark:hover:text-black md:p-0 dark:text-white">
                   Register
               </NavLink>
             </li>
             <li>
               <NavLink to="/signin" className="block py-2 px-3   rounded hover:text-orange-600 dark:hover:text-black md:p-0 dark:text-white">
                   Sign In 
               </NavLink>
             </li>
          </>
